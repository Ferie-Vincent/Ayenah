...
class StoreEnregistrementRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'volet'        => 'required|in:volet_1_financement',
    ...
    public function messages(): array
    {
        return [
            ...
            'volet.required' => 'Le type de contribution est requis.',
            'volet.in'       => 'Seul le Volet 1 — Financement est ouvert à la candidature.',
